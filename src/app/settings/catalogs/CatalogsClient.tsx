      ...
      <div className="main">
        ...
        <div style={{ padding: '24px 32px', maxWidth: 640 }}>
          <p style={{ fontSize: 13, color: 'var(--text-secondary)', marginBottom: 24 }}>
            Cada catálogo apunta a una carpeta de fotos independiente. Puedes cambiar entre ellos en cualquier momento.
          </p>
          ...
          <div style={{ borderTop: '1px solid var(--border)', paddingTop: 24 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              ...
              <input
                className="tag-input"
                placeholder="Ruta absoluta (p.ej. /Volumes/Backup/Photos)"
                value={newPath}
