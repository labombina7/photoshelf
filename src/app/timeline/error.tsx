  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ margin: 0, fontWeight: 600, fontSize: 14, color: '#b91c1c' }}>
        ...
        {error.digest && (
          <p style={{ margin: '4px 0 0', fontSize: 11, color: '#b91c1c', opacity: 0.7 }}>
            Digest: {error.digest}
          </p>
        )}
      </div>
      <button
        ...
        style={{
          ...
          background: '#b91c1c', color: '#fff', fontSize: 13, cursor: 'pointer',
        }}
      >
        Reintentar
      </button>
