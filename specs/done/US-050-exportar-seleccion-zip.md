...
> Estado: ❌ Descartada — sustituida por US-092. El flujo de compartir via share token cubre el caso de uso de descarga; desde móvil el SO gestiona la descarga directamente.
